...
<footer class="footer">
    <div class="footer-container">
        <div class="footer-section logo">
            <img src="./imgs/logo_trans.png" alt="University Logo" class="footer-logo" width="50">
        </div>
        ...
        <div class="footer-section social">
            <h4>Follow Us</h4>
            <ul>
                <li><a href="https://www.facebook.com/university"><i class="fab fa-facebook-f"></i> Facebook</a></li>
                <li><a href="https://www.instagram.com/university"><i class="fab fa-instagram"></i> Instagram</a></li>
                <li><a href="https://plus.google.com/university"><i class="fab fa-google"></i> Google</a></li>
                <li><a href="https://www.youtube.com/university"><i class="fab fa-youtube"></i> YouTube</a></li>
            </ul>
        </div>
    </div>
    <div class="footer-bottom">
        <p>&copy; 2025 The University Digest. All rights reserved.</p>
    </div>
</footer>
</body>
</html>
