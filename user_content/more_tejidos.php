      ...
      <?php foreach ($tejidos as $tejido): ?>
        <div class="tejido-card">
          ...
          <div class="post-admin">
            ...
            <div>
              <a href="author_tejidos.php?author=<?= $tejido['created_by']; ?>">
                <?= htmlspecialchars($tejido['author_user_name']) ?>
              </a>
            </div>
          </div>
          <div class="tejido-content">
            ...
            <div class="description-wrapper">
              <p class="tejido-description collapsed"><?= htmlspecialchars($tejido['description']) ?></p>
              <?php if (strlen($tejido['description']) > 300): ?>
                <button class="toggle-desc-btn">Show more</button>
              <?php endif; ?>
            </div>
