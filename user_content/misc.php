    ...
    <div class="article-card-wrapper">
        ...
        <form action="" method="GET" class="filter-form">
            <div class="input-field search-field">
                ...
                <input type="text" name="search" placeholder="Search news..." class="box" value="<?= htmlspecialchars($search_term); ?>">
            </div>
            ...
            <a href="news.php?search=&sort=newest" class="inline-option-btn">
